...
import scala.language.postfixOps                               // Import JUnit’s @RunWith annotation to delegate execution to an external runner
...
class PractiseTestRun // Empty body is fine; class merely acts as a configuration holder
